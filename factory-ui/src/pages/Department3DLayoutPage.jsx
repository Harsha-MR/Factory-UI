...
export default function Department3DLayoutPage() {
  ...
  const addMachineFromSidebar = () => {
    ...
    if (pendingMachinePlacement) {
      setMachineFormError(
        "Finish placing the current machine before adding another.",
      );
      return;
    }
    ...
    pushToast({
      kind: "info",
      message:
        "Move the cursor over the floor and click when the cyan preview aligns with your target spot.",
      ts: Date.now(),
    });
  };
