    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-3 lg:p-4">
          {/* FIRST ROW - Current Status (Left) and OEE (Right) */}
          ...
          {/* SECOND ROW - GANTT CHART - Full Width */}
          ...
          {/* THIRD ROW - Hourly Part Count (Left) and Machine Power + Status Duration (Right) */}
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-2 lg:gap-4">
            {/* LEFT COLUMN - Hourly Part Count Chart */}
            <div className="flex flex-col gap-3 lg:gap-2">
            ...
            {/* RIGHT COLUMN - Machine Power Metrics + Status Duration */}
            <div className="flex flex-col gap-3 lg:gap-2">
